...
format_data(rcp="rcp45", type="finfish")
format_data(rcp="rcp60", type="finfish")
format_data(rcp="rcp85", type="finfish")

# Bivalves
format_data(rcp="rcp26", type="bivalve")
format_data(rcp="rcp45", type="bivalve")
